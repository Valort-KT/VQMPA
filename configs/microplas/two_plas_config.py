...
_C.DATA.DATA_PATH = ''
# Dataset name
_C.DATA.DATASET = 'plastic'
# Input image size
_C.DATA.IMG_SIZE =300
...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'vq2v2_de'
# Model name
_C.MODEL.NAME = '3vq2v2_de'
...
def update_config(config, args):
    """Update config with additional args."""
    # if args.cfg:
